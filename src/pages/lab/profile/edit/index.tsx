...
import { useLabUpdateProfileMutation } from '../../../../apis/lab/profile';
...
import { LabEditAvailabilityProfile } from './Availability';
import { LabEditPersonalProfile } from './Personal';
import { LabEditProfessionalProfile } from './Professional';
...
export const LabEditProfile = () => {
	...
	const { mutateAsync: updateProfile } = useLabUpdateProfileMutation();
		...
		<FormProvider {...methods}>
			<form onSubmit={methods.handleSubmit(onSubmit)}>
				<div className="pb-3">
					...
					{step === 1 && <LabEditPersonalProfile setStep={setStep} />}
					{step === 2 && <LabEditProfessionalProfile setStep={setStep} />}
					{step === 3 && <LabEditAvailabilityProfile setStep={setStep} />}
				</div>
			</form>
		</FormProvider>
	);
