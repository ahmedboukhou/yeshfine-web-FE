...
export const DoctorMainCard = () => {
	...
	return (
		<div className="bg-white rounded-2xl border border-border-1 min-h-44">
			<div className="flex flex-col md:flex-row md:p-6 gap-2">
				<div className=" flex-center">
					{/* md:bg-[linear-gradient(111deg,#1298BC_-37.21%,#88D702_115.79%)] */}
          <img
