...
export const PatientProfile = () => {
	...
	return (
		<section>
			...
			<div className="rounded-2xl bg-white border border-border-1 flex flex-col h-[calc(100vh-20rem)]">
				<div className="bg-[linear-gradient(111deg,#1298BC_-37.21%,#88D702_115.79%)] h-38 rounded-t-2xl" />
